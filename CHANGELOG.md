...
### Released
- Published **release-readiness-gatekeeper** as a public, portfolio-grade system focused on platform governance.
...
### Shipped
- Cut the first coherent internal version of **release-readiness-gatekeeper** with stable domain objects, review surfaces, and decision outputs.
